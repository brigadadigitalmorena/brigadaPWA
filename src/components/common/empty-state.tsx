  ...
  return (
    <div className={cn('w-full', className)}>
      <Card className="w-full rounded-2xl border-dashed py-8 shadow-sm">
        <CardHeader className="justify-items-center px-6 text-center sm:px-10">
          ...
          <CardDescription className="mx-auto max-w-prose text-base leading-relaxed text-center">
            {description}
          </CardDescription>
